        ...
        <div class="content">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <img src="./img/contact.jpg" class="img-responsive contact-img" alt="Call Us">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <div class="box-padding-rl">
                            ...
                            <p class="text-muted">Follow On : Facebook,Twitter<a href="#"><i class="fa fa-instagram"></i></a> <a href="#"><i class="fa fa-facebook-square"></a></i></p>                  
                        </div>
                    </div>
                </div>
            </div>
